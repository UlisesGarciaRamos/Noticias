...
<script type="text/javascript">
		$(document).ready(function(){ 
		    ...
		    var nombreUsuario = "";
		    function guardarUsuario(usuario,email,contrasena){
				var parametros = {
		                "signup-username" : usuario,
		                "signup-email" : email,
						"signup-contrasena" : contrasena
		        };
		        $.ajax({
		                data:  parametros,
		                url:   'http://localhost/proyecto clase/php2/conexion.php',
		                type:  'post',
		                beforeSend: function () {
...
<div id="cd-login"> <!-- log in form -->
	...
	<form  class="cd-form"> 
					...
					<p class="fieldset">
						...
						<input class="full-width has-padding has-border" id="signup-username"  name = "signup-username" type="text" placeholder="Usuario">
						<span class="cd-error-message">Error message here!</span>
					</p>
					...
					<p class="fieldset">
						<input type="submit"  class="full-width has-padding" value="Registrar" >
