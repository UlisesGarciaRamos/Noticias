...
if ($resultado = mysqli_query($enlace, $consulta)) {
    ...
    while ($fila = mysqli_fetch_row($resultado)) {
		...
		echo "<form class='contacto' action='../php/eliminacionAdmin.php' method='post'>";
		echo ('<tr>
<div><label>Id:</label> 
...
<input type="text" name="usuario"  value="'.$fila[1].'" maxlength="50">
</div>');

echo ('
<div><label>Nombre:</label>
<td><input type="text" name="nombre" value="'.$fila[2].'" maxlength="50">
</div>');

echo ('
<div><label>Apellidos:</label>
<input type="text" name="apellidos"  value="'.$fila[3].'" maxlength="50"></div>');
